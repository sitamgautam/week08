...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Updated with actual IP addresses from deployed backend services
    const PRODUCT_API_BASE_URL = 'http://4.200.135.79:8000'; // Replace with your actual Product Service IP
    const ORDER_API_BASE_URL = 'http://4.200.143.54:8001';   // Replace with your actual Order Service IP
